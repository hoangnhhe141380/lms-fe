...
const CloneGroup = () => {
  ...
  const modalConfirm = () => {
    Modal.confirm({
      title: 'Are you sure to confirm clone this configure group for this milestone?',
  ...
  const handleFinish = async () => {
    await groupApi
      .overrideClone(id, reuse.milestoneId)
      .then((response) => {
        toastMessage('success', 'Clone Group Successfully!')
      })
      .catch((error) => {
